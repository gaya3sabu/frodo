...
public partial class Bankadmin_AccountDetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {     
            ...
            {
                DataTable dt = db.selectquery("select * from Accont where accountno= '" + Session["accountno"] + "'");
                GridView1.DataSource = dt;
                GridView1.DataBind();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        string encptn = row.Cells[9].Text;
        string binary = row.Cells[10].Text;
        ...
        body += "Encryption Key : " + encptn + "\n";
        body += "binary Code : " + binary + "\n";
        ...
        int a = db.exequery("update Accont set Status='Approved', accountno='"+ uniqueId + "',username='"+ mail + "',password='"+ otp+"' where Aid='" + requestNo + "'");
         ...
         int b = db.exequery("update TransactionDetails set Accountno='"+ uniqueId+ "' where trid='" + requestNo + "'");
       // Response.Redirect("BANKING/DepositeAmount.aspx");
        showdetails();
    }
